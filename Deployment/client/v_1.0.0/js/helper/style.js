...
define([],
    function(){
        var Style = function() {
            ...
            BTN_ACCOUNT = _el("#btn_account");
            BTN_LOGOUT = _el("#btn_logout");
            BTN_HOME = _el("#btn_home");
            ...
            this.render = function () {
                ...
                switch (route){
                    ...
                    case "#account": _action(this,_action_account_desktop,_action_account_tablet,_action_account_mobil);break;
                }
            };
            ...
            _action_account_desktop = function(){
                _hel(BTN_ADD);
                _hel(BTN_ACCOUNT);
                _vel(BTN_LOGOUT);
                _vel(BTN_HOME);
            ...
            _action_account_tablet = function(){
                _action_account_desktop();
            };

            _action_account_mobil = function(){
                _action_account_desktop();
            };
        };
